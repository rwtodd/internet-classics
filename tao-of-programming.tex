...
\usepackage[letterpaper, total={5.6in, 8in}]{geometry}
\usepackage{color}
\renewcommand{\rmdefault}{ppl}

\definecolor{my-red}{rgb}{0.7,0,0.2}
\definecolor{my-gray}{rgb}{0.2,0.2,0.4}
...
% make \fmtXXX macros that \@seccntformat branch out to..
\def\fmtsection#1{\makebox[0pt][l]{\rule[-1ex]{\dimexpr\textwidth+\intomargin}{2pt}}Book \thesection\ --- }
\def\fmtsubsection#1{\makebox[\intomargin][l]{\thesubsection}}
\makeatletter
\renewcommand{\@seccntformat}[1]{\csname fmt#1\endcsname} 

% redefine \section so that it goes left into the margins...
...
% redefine \subsection so it goes into the margins and doesn't space down after 
...
% some special markup for our specific layout...
...
\newenvironment{versesect}{\begin{minipage}[t]{5.5in}\begin{verse}}%
{\end{verse}\end{minipage}\vspace{\partopsep}\vspace{\topsep}}

\title{\color{my-red}The Tao of Programming}
...
But do not program in {\small COBOL} if you can avoid it.
