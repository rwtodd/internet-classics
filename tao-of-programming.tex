...
% make skips a little more stretchable to help find page breaks
\bigskipamount=12pt plus6pt minus4pt
\medskipamount=6pt plus3pt minus2pt

\def\unindent{{\parindent=-\leftskip\leavevmode}}
...
\def\book#1#2{\null\bigbreak\goodbreak{\unindent\biggerbold Book #1 --- #2}\par\unindent\ignorespaces}
\def\sect#1{\null\medbreak\leavevmode\llap{\hbox to \leftskip{\bf #1\hfil}}\ignorespaces}

% startverse and vsect help format verses (poetry)
\def\versebase{\begingroup\advance\leftskip by \margskip \rightskip=\leftskip \obeylines \parskip=2pt}
\def\startverse{\smallskip\leavevmode\versebase}
\def\vsect#1{\null\medbreak\versebase\leavevmode\llap{\hbox to \leftskip{\bf #1\hfil}}\ignorespaces}
\def\endverse{\endgroup\smallskip}
...
\vsect{5.1} A well-used door needs no oil on its hinges.
