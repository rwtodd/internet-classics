%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% indent everything a little, except headings... margskip = "margin skip"
\newskip\margskip \margskip=25pt
\advance\leftskip by \margskip 
\def\unindent{{\parindent=-\margskip\leavevmode}}

% set up 12-point fonts for everything
\font\twelverm=cmr12
\font\twelvesl=cmsl12
\font\twelvebf=cmbx12
...
\def\book#1#2{\bigbreak\unindent{\biggerbold Book #1 --- #2}\par\unindent\ignorespaces}
\def\sect#1{\medskip\unindent\hbox to \margskip{\bf #1\hfil}\ignorespaces}
\def\poetry#1{{\par \advance\leftskip by \margskip \rightskip=\leftskip\smallskip#1\smallskip}}
\def\quotation#1{{
    \medskip \advance\leftskip by \margskip \rightskip=\leftskip
    \leavevmode\llap{``}{\sl #1}''\medskip}}
\parindent=0pt
...
\subtitle{Translated by Geoffrey James}
\vskip 1in

\book{1}{The Silent Void}
Thus spake the Master Programmer:
\quotation{When you have learned to snatch the error code from the trap frame, it will be time for you to leave.}

\sect{1.1}
Something mysterious is formed, born in the silent void. waiting alone and unmoving, it is at once still and yet in constant motion. It is the source of all programs. I do not know its name, so I will call it the Tao of Programming.

\poetry{If the Tao is great, then the operating system is great.\hfil\break
If the operating system is great, then the compiler is great.\hfil\break
If the compiler is great, then the application is great.\hfil\break
...
Thus spake the Master Programmer:
\quotation{After three days without programming, life becomes meaningless.}

\sect{2.1}
The programmers of old were mysterious and profound. We cannot fathom their thoughts, so all we do is describe their appearance.

\poetry{Aware, like a fox crossing the water.\hfil\break
Alert, like a general on the battlefield.\hfil\break
Kind, like a hostess greeting her guests.\hfil\break
Simple, like uncarved blocks of wood.\hfil\break
...
\book{3}{Design}
Thus spake the Master Programmer:
\quotation{When a program is being tested, it is too late to make design changes.}
...
\book{4}{Coding}
Thus spake the Master Programmer:
\quotation{A well-written program is its own Heaven; a poorly-written program is its own Hell.}
...
\book{5}{Maintenance}
Thus spake the Master Programmer:
\quotation{Though a program be but three lines long, someday it will have to be maintained.}

\sect{5.1}
\poetry{A well-used door needs no oil on its hinges.\hfil\break
A swift-flowing stream does not grow stagnant.\hfil\break
A deer blends perfectly into the forest colors.\hfil\break
...
\sect{5.4}
\poetry{Does a good farmer neglect a crop he has planted?\hfil\break
Does a good teacher overlook even the most humble student?\hfil\break
Does a good father allow a single child to starve?\hfil\break 
Does a good programmer refuse to maintain his code?}

\book{6}{Management}
Thus spake the Master Programmer:
\quotation{Let the programmers be many and the managers few---then all will be productive.}

\sect{6.1}
\poetry{When managers hold endless meetings,\hfil\break
  \null\quad the programmers write games.\hfil\break
  When accountants speak of quarterly profits,\hfil\break
  \null\quad the development budget is about to be cut.\hfil\break
  When senior scientists talk blue sky,\hfil\break
  \null\quad the clouds are about to roll in.}

Truly, this is not the Tao of Programming.

\poetry{When managers make commitments,\hfil\break
  \null\quad game programs are ignored.\hfil\break
  When accountants make long-range plans,\hfil\break
  \null\quad harmony and order are about to be restored.\hfil\break
  When senior scientists address the problems at hand,\hfil\break
  \null\quad the problems will soon be solved.}

Truly, this is the Tao of Programming.

\sect{6.2}
\poetry{Why are programmers non-productive?\hfil\break
  \null\quad Because their time is wasted in meetings.\hfil\break
  Why are programmers rebellious?\hfil\break
  \null\quad Because the management interferes too much.\hfil\break
  Why are the programmers resigning one by one?\hfil\break
  \null\quad Because they are burnt out.\hfil\break
  Having worked for poor management,\hfil\break
  \null\quad they no longer value their jobs.}
...
Thus spake the Master Programmer:
\quotation{You can demonstrate a program for a corporate executive, but you can't make him computer literate.}
...
Thus spake the Master Programmer:
\quotation{Without the wind, the grass does not move. Without software hardware is useless.}
...
\book{9}{Epilogue}
Thus spake the Master Programmer:
\quotation{Time for you to leave.}
