...
A fundimental problem.  When Microsoft and \acro{IBM} first came out with \acro{OS/2}~1.1
...
386 machines quickly took over from 286 machines, and \acro{IBM} and MS were
...
believe that \acro{AT\&T} controlled the standard, not MS, and that belief would
...
the new stuff, and by that time MS will have it's {\bfseries next} release out.
...
{\leftskip=1in
Gordon Letwin\\
not a Microsoft spokesperson\par}
