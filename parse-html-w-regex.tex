...
%de{\it stroyi\rayz{-1pt}{`\thinspace$\check{}$'}%
%\rayz{-1.5ex}{'\thinspace\thinspace$\hat{}$`}%
...
e} n{\bf ot
re\rayz{0pt}{$\grave{\phantom{e}}$}\rayzl{1.5ex}{u}\rayz{1ex}{$\hat{\thinspace}$}%
a\rayzl{1.2ex}{c\thinspace}%
\~l\rayzl{2.3ex}{e}\rayz{2.2ex}{$^{^{\wr}}$}%
\rayz{0ex}{$\skew9_{_{\vdash}}$}\rayz{-0.4ex}{$\skew9_{_{\perp}}$}\rayz{-1ex}{$\skew9_{_{\dashv}}$}
ZALGO IS T}ONy
